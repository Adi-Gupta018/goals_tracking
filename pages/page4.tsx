...
import { Dumbbell, Flame, Utensils, Waypoints } from 'lucide-react';

export default function page4 (){
    return(
        <div className="flex flex-col bg-[#1F1F1F] text-center m-auto  text-white min-h-screen p-4 ">
            page 4
        <div className="flex-grow">
        <div className=" fixed bottom-0 left-0 w-full bg-gray-900 text-gray-400 flex justify-around items-center py-3">
        <Link href="/"> {/* Link to Page 1 (default) */}
          <div className="flex flex-col items-center">
            ...
            <span className="mt-1">Page1</span>
          </div>
        </Link>
        ...
        <Link href="/page4"> {/* Link to Page 4 */}
          <div className="flex flex-col items-center">
            <Waypoints className=' text-red-600'/>
            ...
            <span className="mt-1  text-red-600">Page4</span>
          </div>
        </Link>
      </div>
        </div>
